...
<h1>Members Admin</h1>
<p>
    <a href="members_input.php">
        <input type="button" class="btn btn-primary" value="Buat members Baru" />
    </a>
</p>
<?php
if ($sukses) {
    ...
    <tbody>
        ...
        if ($katakunci != '') {
            ...
            for ($x = 0; $x < count($array_katakunci); $x++) {
                $sqlcari[] = "(nama like '%" . $array_katakunci[$x] . "%' or email like '%" . $array_katakunci[$x] . "%' or isi like '%" . $array_katakunci[$x] . "%')";
            }
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="members_input.php?id=<?php echo $r1['id']?>">

...
<head>
    ...
    <title>All About Paskibraka</title>
    <link rel="stylesheet" href="<?php echo url_dasar()?>/css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'>All About Paskibraka</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar()?>#home">Home</a></li>
                    <li><a href="<?php echo url_dasar()?>#history">History</a></li>
                    <li><a href="<?php echo url_dasar()?>#events">Events</a></li>
